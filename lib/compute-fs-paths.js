...
function computeFsPaths(opts) {
  ...
  //Make the path os specific for linux and OSX since there are no extensions
  if(process.platform !== 'win32'){
    fsPaths.chrome.installPath += '-' + process.platform;
    fsPaths.firefox.installPath += '-' + process.platform;
  }
